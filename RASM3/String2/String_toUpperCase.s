...
//Purpose :
 /*
    takes a string pointer as an argument, converts all lowercase characters in the string to uppercase characters, 
	and returns a pointer to the modified string; doesnt output
*/
	//.data  
...
loop:
       ...
       // Check if the character is lowercase (ASCII value between 97 and 122)
        cmp w1, 97  //checking whether the value in W1 is less than 97, and if it is, it will brnach to skip label
        blt skip
        cmp w1, 122 // if the value in W1 is greater than 122, the BGT instruction will jump to the "skip" label
        bgt skip
